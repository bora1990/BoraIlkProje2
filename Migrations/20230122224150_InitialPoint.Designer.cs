...
namespace BoraIlkProje2.Migrations
{
    ...
    [Migration("20230122224150_InitialPoint")]
            ...
            modelBuilder.Entity("BoraIlkProje2.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Price = 9081m,
                            ProductName = "Abbott Ccc"
                        },
                        new
                        {
                            Id = 2,
                            Price = 7072m,
                            ProductName = "Welch and Partners"
                        },
                        new
                        {
                            Id = 3,
                            Price = 6962m,
                            ProductName = "Jones Corp."
                        },
                        new
                        {
                            Id = 4,
                            Price = 9696m,
                            ProductName = "Roberts PLC"
                        },
                        new
                        {
                            Id = 5,
                            Price = 5391m,
                            ProductName = "Power Incorporated"
                        },
                        new
                        {
                            Id = 6,
                            Price = 5123m,
                            ProductName = "Lewis Ltd"
                        },
                        new
                        {
                            Id = 7,
                            Price = 7107m,
                            ProductName = "Akhtar LP"
                        },
                        new
                        {
                            Id = 8,
                            Price = 6789m,
                            ProductName = "Walker Inc"
                        },
                        new
                        {
                            Id = 9,
                            Price = 9597m,
                            ProductName = "Swift CIO"
                        });
                });
